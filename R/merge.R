...
#'
#' @param x,y [[ernest_run]]\cr
#' Runs generated from compatible nested sampling specifications.
...
#' Simplify nested sampling results into a basic list for
#' merging.
#'
...
#' @noRd
butcher <- function(x, first_id = 1) {
  # Turn the IDs in x$weights$id into a sequence starting at first_id
