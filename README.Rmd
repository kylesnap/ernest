...
Install the development version of ernest from [GitHub](https://github.com/ropensci/ernest) with:
``` r
...
NS has been implemented in many languages. This non-exhaustive list of popular NS implementations is adapted from [Fowlie (2021)](http://arxiv.org/abs/2010.13884):
