...
2. Robustness to complex or poorly conditioned distributions (e.g., multimodal or discontinuous);
3. Simultaneous estimation of the posterior distribution;
4. Natural stopping criteria—no need for burn-in or manual convergence checks.
...
The nestcheck Python package provides routines for diagnosing nested sampling runs [@anesthetic].
