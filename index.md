...
- **Familiar methods**: Sampler specifications and results are stored in
  S3 objects. Start or continue an NS run with
  [`generate()`](https://generics.r-lib.org/reference/generate.html),
  review results with
  [`summary()`](https://rdrr.io/r/base/summary.html), and simulate
...
- **About NS**:
  [`vignette("nested-sampling-with-ernest")`](https://kylesnap.github.io/ernest/articles/nested-sampling-with-ernest.md),
