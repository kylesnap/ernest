...
#' nested sampling, including tests for the dynesty NS package. These problems
#' are additionally used within ernest's test suite to validate its behaviour.
#' @srrstats {G5.1} Tests and test data are made available here for users to
#' interact with.
#' @srrstats {BS1.1} Provides an example on how to enter data through an
#' anonymous function.
```
