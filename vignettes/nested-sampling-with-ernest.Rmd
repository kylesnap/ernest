...
In Bayesian inference, we use probabilities to represent our current beliefs about a model’s unobservable parameters. When we gather new data, we update these beliefs using Bayes' theorem:
$$
